...
timeit verilator --cc -DSYNTHESIS --Wno-fatal -CFLAGS "-O2" --threads 4 $design.v 2>&1 | tee compile.log
python3 $BASE_DIR/gentb.py $design > ${design}_tb.cpp
verilator --cc -DSYNTHESIS --Wno-fatal -CFLAGS "-O2" --threads 4 --exe $design.v ${design}_tb.cpp
